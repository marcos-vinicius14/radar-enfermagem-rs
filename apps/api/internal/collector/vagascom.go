...
var _ Collector = (*VagasComCollector)(nil)
...
func (c *VagasComCollector) Collect(ctx context.Context, query SearchQuery) ([]RawJob, error) {
...
func (c *VagasComCollector) parseHTML(body []byte, query SearchQuery) ([]RawJob, error) {
	...
	results := make([]RawJob, 0, len(cards))
