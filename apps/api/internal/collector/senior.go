...
var _ Collector = (*SeniorCollector)(nil)
...
func (c *SeniorCollector) Collect(ctx context.Context, query SearchQuery) ([]RawJob, error) {
...
func (c *SeniorCollector) parseJSON(body []byte, query SearchQuery) ([]RawJob, error) {
	var payload struct {
	...
	results := make([]RawJob, 0, len(payload.Contents))
