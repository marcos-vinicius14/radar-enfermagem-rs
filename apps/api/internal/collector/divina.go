...
var _ Collector = (*DivinaCollector)(nil)
...
func (c *DivinaCollector) Collect(ctx context.Context, query SearchQuery) ([]RawJob, error) {
...
func (c *DivinaCollector) parseHTML(body []byte, query SearchQuery) ([]RawJob, error) {
	...
	results := make([]RawJob, 0, len(matches))
