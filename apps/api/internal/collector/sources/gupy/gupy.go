...
var _ collector.Collector = (*GupyCollector)(nil)
...
func (c *GupyCollector) Collect(ctx context.Context, query collector.SearchQuery) ([]collector.RawJob, error) {
...
func (c *GupyCollector) parseHTML(body []byte, query collector.SearchQuery) ([]collector.RawJob, error) {
	...
	results := make([]collector.RawJob, 0, len(jobsList))
