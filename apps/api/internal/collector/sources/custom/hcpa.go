...
var _ collector.Collector = (*HCPACollector)(nil)
...
func (c *HCPACollector) Collect(ctx context.Context, query collector.SearchQuery) ([]collector.RawJob, error) {
...
func (c *HCPACollector) parseHTML(body []byte, query collector.SearchQuery) ([]collector.RawJob, error) {
	...
	results := make([]collector.RawJob, 0)
